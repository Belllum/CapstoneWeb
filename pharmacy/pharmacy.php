...
/* Styling for the chat messages and adding scroll when needed */
.chat-messages {
...
/* Center the chat container within the table cell */
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-active">
                        <a href="pharmacy.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Pharmacy chat</p></a></div>
                    </td>
                </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Chat with Pharmacy</p>

...
<body>
    ...
    <div class="container">
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn">
                        <a href="patient_alarm.php" class="non-style-link-menu  "><div><p class="menu-text">Medicine Alarm</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn">
                        <a href="pharmacy.php" class="non-style-link-menu"><div><p class="menu-text">Pharmacy chat</p></a></div>
                    </td>
                </tr>

             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session ">
                        <a href="alarm.php" class="non-style-link-menu "><div><p class="menu-text">Medicine Alarm</p></div></a>
                    </td>
                </tr>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table id="tbody" width="100%" class="sub-table scrolldown" border="0" style="padding: 50px;border:none">
        ...
        <td style="width: 25%;">
            <div class="dashboard-items search-items">
                <div style="width:100%">
                    ...
                    <div class="h4-search">
                        Dummy Date 1<br>Starts: <b>@Time 1</b> (24h)
                    </div>
                    <br>
        ...
        <td style="width: 25%;">
            <div class="dashboard-items search-items">
                <div style="width:100%">
                    ...
                    <div class="h4-search">
                        Dummy Date 2<br>Starts: <b>@Time 2</b> (24h)
                    </div>
                    <br>
        ...
        <td style="width: 25%;">
            <div class="dashboard-items search-items">
                <div style="width:100%">
                    ...
                    <div class="h4-search">
                        Dummy Date 3<br>Starts: <b>@Time 3</b> (24h)
                    </div>
                    <br>

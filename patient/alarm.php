...
<body>
    ...
    echo '<script>';
    echo 'var userid = ' . $userid . ';'; // Assign the value to the JavaScript variable
    echo '</script>';
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Medicine Alarm</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                        ...
                        <tr>
                            <td style="width: 25%; display:none;">
                                <div class="dashboard-items search-items">
                                    <div style="width:100%">
                                        <div class="h1-search"></div><br>
                                        <div class="h3-search"></div>
                                        <div class="h4-search"></div>
                                        <br>
                                        <a href="#">
                                        <button id="doneButton" class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%">
...
<script src = "../script/showAlarm.js">
    </script>
<script src = "../script/alarmRing.js">
</script>
</body>
</html>
